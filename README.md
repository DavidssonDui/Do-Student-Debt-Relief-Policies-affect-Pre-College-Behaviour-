...
To reproduce, download the relevant NYSED Report Card CSVs for 2009–2017 from the [NYSED downloads page](https://data.nysed.gov/downloads.php) and place them in the same directory as the notebook (the loading cells expect filenames of the form `Demographic_Factors2013.csv`, etc.).
